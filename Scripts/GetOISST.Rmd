...
This code downloads the NOAA 1/4° Daily Optimum Interpolation Sea Surface Temperature (DOISST) dataset and calculates marine heatwaves metrics for Australia and the USA.
